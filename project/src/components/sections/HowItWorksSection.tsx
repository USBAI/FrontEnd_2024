  ...
  return (
    <section className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">How Kluret Works</h2>
          <p className="text-xl text-gray-400">Simple steps to find your perfect product</p>
        </motion.div>
          ...
          {steps.map((step, index) => (
            ...
            >
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-16 right-0 w-full h-0.5 bg-gradient-to-r from-blue-500/50 to-transparent transform translate-x-1/2" />
              )}
