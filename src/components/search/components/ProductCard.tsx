        ...
        <div className="aspect-square relative overflow-hidden bg-white">
          ...
          <div className="discounts-div">
            ...
            >
              ...
              <svg className="" width="20" height="14" viewBox="0 0 23 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="p-4 bg-white">
          ...
          <div className="flex items-center justify-between">
            <div className='w-full'>
              <div className="text-lg font-semibold text-gray-900 w-full justify-between flex pb-2 max-[800px]:text-[15px]">
                {localPrice}
