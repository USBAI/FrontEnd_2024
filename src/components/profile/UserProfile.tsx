...
import { User, Settings, Package, LogOut, ShoppingCart, X, Menu } from 'lucide-react';
    ...
    >
      ...
      <div className="h-[calc(100%-4rem)] md:h-full flex">
        ...
        <motion.div
          ...
          className="fixed md:static top-[4rem] md:top-0 left-0 h-[calc(100%-4rem)] md:h-full w-64 bg-white/5 backdrop-blur-xl border-r border-white/10 p-6 z-50 md:translate-x-0"
        >
          {/* Profile Header */}
