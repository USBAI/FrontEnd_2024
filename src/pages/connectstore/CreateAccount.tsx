...
import { Store, ArrowLeft, Check, Building2, Globe, Lock, Mail, CreditCard } from 'lucide-react';
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className="text-2xl font-bold">Create Your Store Account</h1>
                    ...
                    {storeTypes.map((type) => (
                      ...
                      >
                        <input
                          ...
                          name="storeType"
                          value={type.value}
                          checked={formData.storeType === type.value}
                          onChange={handleChange}
                          className="sr-only"
                        />
