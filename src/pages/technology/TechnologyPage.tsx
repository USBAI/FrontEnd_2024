      ...
      <main className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative aspect-[16/9] bg-black/50 rounded-xl p-8">
                ...
                <div className="w-full max-w-3xl">
                  <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                      <div className="h-16 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg flex items-center justify-center text-sm font-medium">
                        User Query
                      </div>
                      <div className="h-16 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg flex items-center justify-center text-sm font-medium">
                        Product Data
                    ...
                    {/* Processing Layer */}
                    <div className="space-y-4">
                      <div className="h-40 bg-gradient-to-r from-pink-500/20 to-purple-500/20 rounded-lg flex items-center justify-center text-sm font-medium p-4 text-center">
          ...
          >
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="text-gray-400">Daily Searches</div>
            </div>
          </motion.div>
        </div>
      </main>
