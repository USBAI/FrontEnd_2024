...
const ProductUpdatesPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-white to-gray-100 text-black">
      <Navbar />
      ...
      <main className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 mb-16">
            {updates.map((update, index) => (
              ...
              >
                ...
                <div className="relative bg-white shadow-lg p-6 rounded-xl border border-gray-200">
                  <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium bg-blue-500/10 text-blue-500 px-2 py-1 rounded-full">
                        v{update.version}
                      </span>
                    </div>
                  </div>
          ...
          <motion.div
            ...
            className="bg-white shadow-lg rounded-2xl p-8 border border-gray-200 text-center"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-black"
              />
