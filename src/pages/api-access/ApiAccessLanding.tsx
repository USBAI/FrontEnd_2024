          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <motion.button
                ...
                onClick={() => navigate('/accessapi/create-account')}
            ...
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
                  ...
                  <button
                    onClick={() => navigate('/accessapi/create-account')}
                    className="w-full py-3 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium hover:from-blue-600 hover:to-purple-600 transition-all"
                  >
                    Get Started
                  </button>
                </div>
...
export default ApiAccessLanding;